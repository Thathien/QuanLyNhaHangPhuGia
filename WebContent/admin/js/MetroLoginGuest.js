...
var UserEnterMessage = "Chọn số bàn";
...
function isCorrect(IsCorrect)
{
	if(IsCorrect == 1)
	{
		...
		window.location.replace("inputTableGuest.jsp");
	}else{
		UnLoading();
	}
}
...
function ChangeColor(HTMLcolor)
{
	...
	$("#botLogInGuest").css("background-color", "rgb(213, 148, 78)");
